...
好，这是我今天分享的主题：从上下文工程到 Harness Engineering。今天我的分享不聊框架，也不聊产品，我聊一聊大家可以带走哪些有收获的想法，帮助大家提升一下认知。
...
到这里大家会思考一个问题：今天的 AI Coding 产品以及所有的 Agent 产品，它为什么长这个模样？其实在 2022 年 ChatGPT 刚出来的时候，有一篇非常知名的论文叫 ReAct。它定义了今天 Agent 是什么样的。
